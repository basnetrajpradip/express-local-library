...
exports.index = asyncHandler(async (req, res, next) => {
  //Get details of book instances, authors and genre counts(in parallel)
  const [numbBooks, numBookInstances, numAvailableBookInstances, numAuthors, numGenres] = await Promise.all([
...
exports.book_detail = asyncHandler(async (req, res, next) => {
  //Get details of book, book instances for specific book
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  const [book, allBookInstances] = await Promise.all([Book.findById(req.params.id).populate("author").populate("genre").exec(), BookInstance.find({ book: req.params.id }).exec()]);
  if (book === null) {
...
exports.book_update_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    //Create Book object with escaped/trimmed data and id.
    const book = new Book({
      title: req.body.title,
      author: req.body.author,
      summary: req.body.summary,
